	...
	<?php if(isset($_GET['action']) && $_GET['action']=='logout'){
		...
		<ul>
			...
			<div class="dropdown">
				...
				<a href="admission_arts.php">Arts</a>
				<a href="admissionscience.php">Science</a>
				<a href="admissioncommerce.php">Commerce</a>
				</div>
			</div> 
			<div class="dropdown">
			<li><a href="#">Job</a></li>
				<div class="dropdown-content">
				<a href="bcs.php">Bcs</a>
				<a href="bank.php">Bank</a>
				<a href="primary.php">Primary</a>
				<a href="jobother.php">Others</a>
